...
def main():
    soma = tiledbsc.SOMA(uri="./converted", verbose=True)

    # Do the ingest into TileDB.
    soma.from_h5ad("/Users/trentsmith/workspace/cellxgene/example-dataset/pbmc3k.h5ad")
    datalocator = DataLocator("/Users/trentsmith/workspace/TileDB-SingleCell/apis/python/tiledb-data")
    CxgDataset(datalocator)
    print("done")


class CxgDataset(DataAdapter):
